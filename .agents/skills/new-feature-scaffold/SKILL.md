...
## 참조 문서 (자동 로드되는 AGENTS.md)

- 패턴 상세: `feature/AGENTS.md`
- Git/PR 규칙: 루트 `AGENTS.md` 의 **Git Convention** 섹션
...
각 파일 템플릿은 `feature/AGENTS.md` 의 코드 샘플을 그대로 사용한다.
...
루트 `AGENTS.md` Module Structure 에 한 줄 추가:
```
- **`feature:<name>`** — <한 줄 설명>
```
